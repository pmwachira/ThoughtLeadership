...
public class WebView_Mags extends AppCompatActivity {
    String link = "https://xpatlink.info/index.php/component/xpatlink/magazine?layout=previous&issue=153";
            ...
            public void onPageFinished(android.webkit.WebView view, String url) {
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
                    webView.evaluateJavascript("" +
                                    "window.onload=document.getElementsByClassName('mid_header')[0].style.display='none';" +
