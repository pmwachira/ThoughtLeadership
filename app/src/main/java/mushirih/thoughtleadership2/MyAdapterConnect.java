 ...
 */
public class MyAdapterConnect extends RecyclerView.Adapter<MyAdapterConnect.ViewHolder> {
...
//    private String email;       //String Resource for header view email
    ...
    @Override
    public MyAdapterConnect.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        if (viewType == TYPE_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_row_connect, parent, false); //Inflating the layout
    ...
    @Override
    public void onBindViewHolder(MyAdapterConnect.ViewHolder holder, int position) {
